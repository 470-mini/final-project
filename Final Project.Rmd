...
grid.arrange(a.3.p, a.3.s, nrow = 1,top = textGrob("I1 Model", gp=gpar(fontface="bold")))
```
...
grid.arrange(a.0.p, a.0.s,nrow = 1,top = textGrob("I1 Model", gp=gpar(fontface="bold")))
```
...
From the table above, **I4 Model** has the largest value of `R-squared`, so we decide to use **I4 Model** as the final model. 
