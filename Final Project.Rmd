...
a.0.p<- ggplot(data = a.0.pred.df, aes(x = Price, y = fit))  + geom_smooth(aes(group = Category, color = Category), method = "lm", se = F) + cbp() + ylab("Predicted Rating") + cbp()
...
a.1.p<-ggplot(data = a.1.pred.df, aes(x = Price, y = fit))  + geom_smooth(aes(group = Category, color = Category), method = "lm", se = F) + cbp() + ylab("Predicted Rating")+cbp()
...
a.2.p<-ggplot(data = a.2.pred.df, aes(x = Price, y = fit))  + geom_smooth(aes(group = Category, color = Category), method = "lm", se = F) + cbp() + ylab("Predicted Rating")+cbp()
...
a.3.p<-ggplot(data = a.3.pred.df, aes(x = Price, y = fit))  + geom_smooth(aes(group = Category, color = Category), method = "lm", se = F) + cbp() + ylab("Predicted Rating")+cbp()
...
a.4.p<-ggplot(data = a.4.pred.df, aes(x = Price, y = fit))  + geom_smooth(aes(group = Category, color = Category), method = "lm", se = F) + cbp() + ylab("Predicted Rating")+cbp()
